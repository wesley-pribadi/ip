...
public class Dyuque {
    ...
    public void newChat() {
        ...
        do {
            ui.showPrompt();
            try {
                executeCommand(ui.readLine()); // updates shouldContinueExecution
            } catch (DyuqueException e) {
    ...
    /**
     * Executes the specified user input as a command,
     * updates whether execution should continue,
     * and returns execution message as String.
     *
